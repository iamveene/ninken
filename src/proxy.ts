...
export function proxy(request: NextRequest) {
  ...
  if (pathname.startsWith("/api/") && !pathname.startsWith("/api/auth") && !pathname.startsWith("/api/health") && !pathname.startsWith("/api/slack/validate-token") && !pathname.startsWith("/api/ninloader/download")) {
    if (!hasToken) {
