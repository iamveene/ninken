...
const auditCards = [
  ...
  {
    id: "cloudtrail-gaps",
    title: "CloudTrail Gaps",
    description: "Regional CloudTrail coverage analysis",
    href: "/aws-audit/cloudtrail-gaps",
    icon: MapPin,
    color: "text-cyan-400",
  },
  {
    ...
    description: "Open inbound rules on sensitive ports",
    href: "/aws-audit/security-groups",
    icon: Network,
    color: "text-teal-400",
  },
  {
    ...
    description: "Rotation compliance analysis (90/180/365-day thresholds)",
    href: "/aws-audit/secrets-rotation",
    icon: RefreshCw,
    color: "text-pink-400",
  },
  {
    id: "lambda-urls",
    title: "Lambda URLs",
    description: "Function URL auth type analysis (NONE = critical)",
    href: "/aws-audit/lambda-urls",
    icon: ExternalLink,
