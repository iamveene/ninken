...
export default function AwsAuditPrivEscPage() {
  const { users, loading: usersLoading, error: usersError } = useAwsIamUsers()
  const { roles, loading: rolesLoading, error: rolesError } = useAwsIamRoles()
  const { policies, loading: policiesLoading, error: policiesError } = useAwsIamPolicies()
