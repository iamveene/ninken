...
export default function M365AuditQueryPage() {
  const {
    query,
    setQuery,
    results,
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        <h1 className="text-lg font-semibold">M365 Audit Query</h1>
        <p className="text-sm text-muted-foreground mt-1">
          Cross-service intelligence search across Microsoft 365. Find credentials,
