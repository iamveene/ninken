...
import { MICROSOFT_SERVICES } from "@/lib/audit/query-adapters"
import type { ServiceId } from "@/lib/audit/query-types"

const SECRET_SERVICES: ServiceId[] = ["outlook", "onedrive"]

type QueryPanel = "library" | "history" | null

export default function M365HuntPage() {
  const {
    query,
    setQuery,
    results,
    ...
    clearHistory,
    removeHistoryEntry,
  } = useAuditQuery(MICROSOFT_SERVICES)
    ...
    <div className="flex flex-col gap-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Search for secrets, credentials, and intelligence across Microsoft 365 services.
        </p>
      </div>
      ...
      <Tabs defaultValue="secrets">
        ...
        <TabsContent value="secrets" className="mt-4">
          <SecretSearchPage
            ...
            providerContext={{ provider: "microsoft", service: "m365" }}
          />
        </TabsContent>
          ...
          <div className="flex flex-col gap-4">
            ...
            {queryPanel === "library" && (
              <QueryLibrary
                ...
                availableServices={MICROSOFT_SERVICES}
              />
            )}
