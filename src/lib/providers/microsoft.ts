...
export function extractAllCredentials(
  ...
  if (raw.Contexts && typeof raw.Contexts === "object") {
    ...
    for (const [name, ctx] of Object.entries(contexts)) {
      ...
      const tenant = (account?.Tenants as string[])?.[0] || "common"
...
export const microsoftProvider: ServiceProvider = {
  ...
  auditNavItems: [
    ...
    { id: "m365-audit-service-principals", title: "Service Principals", href: "/m365-audit/service-principals", iconName: "Blocks" },
    ...
    { id: "m365-audit-ca-bypass", title: "CA Bypass", href: "/m365-audit/ca-bypass", iconName: "ShieldOff" },
  ...
  exploreNavGroups: [
    ...
    },
    {
      label: "Intelligence",
      items: [
        { id: "m365-audit-hunt", title: "Hunt", href: "/m365-audit/hunt", iconName: "Crosshair" },
