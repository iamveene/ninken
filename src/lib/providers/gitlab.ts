...
export const gitlabProvider: ServiceProvider = {
  ...
  auditNavItems: [
    ...
    { id: "gitlab-audit-risk-dashboard", title: "Risk Dashboard", href: "/gitlab-audit/risk-dashboard", iconName: "Shield" },
  ...
  exploreNavGroups: [
    ...
    },
    {
      label: "Intelligence",
      items: [
        { id: "gitlab-audit-hunt", title: "Hunt", href: "/gitlab-audit/hunt", iconName: "Crosshair" },
