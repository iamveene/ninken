...
// Grouped nav items for Explore mode (Audit section + Intelligence section)
...
export interface ServiceProvider {
  ...
  // Grouped nav for Explore mode (Audit + Intelligence sections)
  readonly exploreNavGroups: NavGroup[]
