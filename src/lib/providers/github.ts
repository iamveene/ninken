...
export const githubProvider: ServiceProvider = {
  ...
  auditNavItems: [
    ...
    { id: "github-audit-risk-dashboard", title: "Risk Dashboard", href: "/github-audit/risk-dashboard", iconName: "ShieldAlert" },
  ],
  ...
  exploreNavGroups: [
    ...
    },
    {
      label: "Intelligence",
      items: [
        { id: "github-audit-hunt", title: "Hunt", href: "/github-audit/hunt", iconName: "Crosshair" },
